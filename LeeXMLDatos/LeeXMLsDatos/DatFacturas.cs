...
namespace LeeXMLsDatos
{
	public class DatFacturas : DatAbstracta
	{
		...
		public DataTable obtieneComprobantesFiscalesDatosAdicionalesTraslado(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta, int EstatusId)
		{
			try
			{
				com = new SqlCommand("[selObtieneComprobantesFiscalesPorFechasEstatusEmpresaDAtraslado]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public DataTable obtieneComprobantesFiscalesPorFechaPagoExclusivoDatosAdicionalesTraslado(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta, int EstatusId)
		{
			try
			{
				com = new SqlCommand("[selObtieneComprobantesFiscalesPorFechasPagoExclusivoEstatusEmpresaDAtraslado]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public DataTable obtieneComprobantesFiscalesEgresosDatosAdicionalesTraslado(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta, int EstatusId)
		{
			try
			{
				com = new SqlCommand("[selObtieneComprobantesFiscalesEgresosPorFechasEstatusEmpresaDAtraslado]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public DataTable obtieneComprobantesFiscalesEgresosPorFechaPagoExclusivoDatosAdicionalesTraslado(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta, int EstatusId)
		{
			try
			{
				com = new SqlCommand("[selObtieneComprobantesFiscalesEgresosPorFechasPagoExclusivoEstatusEmpresaDAtraslado]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public DataTable obtieneComprobantesFiscalesNominasPercepciones(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta)
		{
			try
			{
				com = new SqlCommand("[selObtienePercepcionesPorFechasPagoComprobanteFiscalEmpresaBF]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public DataTable obtieneComprobantesFiscalesNominasPercepcionesPorFechaFin(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta)
		{
			try
			{
				com = new SqlCommand("[selObtienePercepcionesPorFechasFinComprobanteFiscalEmpresaBF]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public DataTable obtieneComprobantesFiscalesNominasDeducciones(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta)
		{
			try
			{
				com = new SqlCommand("[selObtieneDeduccionesPorFechasPagoComprobanteFiscalEmpresaBF]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public DataTable obtieneComprobantesFiscalesNominasDeduccionesPorFechaFin(int EmpresaId, DateTime FechaDesde, DateTime FechaHasta)
		{
			try
			{
				com = new SqlCommand("[selObtieneDeduccionesPorFechasFinComprobanteFiscalEmpresaBF]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("FechaDesde", FechaDesde);
				com.Parameters.AddWithValue("FechaHasta", FechaHasta);
		...
		public int agregaComprobanteFiscal(int EmpresaId, int TipoComprobanteId, int ClienteId, string SerieFactura, string NumeroFactura, DateTime Fecha, decimal IVARetenido, decimal ISRRetenido, decimal IVA, decimal SubTotal, decimal SubTotal0, decimal Total, int MonedaId, int FormaPagoId, int MetodoPagoId, string UUID, string Concepto, int FacturaRelacionadaId, string UUIDRelacionado, int TipoRelacionFacturaId, DateTime FechaPago, string Ruta, int UsuarioId)
		{
			try
			{
				int Id = 0;
				com = new SqlCommand("[insAgregaComprobanteFiscalSinPDFXML]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("TipoComprobanteId", TipoComprobanteId);
		...
		public int agregaComprobanteFiscalNeue(int EmpresaId, int TipoComprobanteId, int ClienteId, string SerieFactura, string NumeroFactura, DateTime Fecha, decimal IVARetenido, decimal ISRRetenido, decimal IVA, decimal IEPS, decimal ImpuestoLocal, decimal SubTotal, decimal Descuento, decimal TotalPercepciones, decimal TotalDeducciones, decimal Total, decimal TotalUSD, int MonedaId, decimal TipoCambio, int ObjetoImpuestoId, decimal ObjetoImpuesto01, decimal ObjetoImpuesto02, decimal ObjetoImpuesto03, decimal ObjetoImpuesto04, int FormaPagoId, int MetodoPagoId, string UUID, string Concepto, int FacturaRelacionadaId, string UUIDRelacionado, int TipoRelacionFacturaId, DateTime FechaPago, DateTime FechaInicio, DateTime FechaFin, string ClaveEntFed, string TipoRegimen, string UsoCFDI, string Ruta, int VersionCFDIId, int UsuarioId)
		{
			try
			{
				int Id = 0;
				com = new SqlCommand("[insAgregaComprobanteFiscalNeue40]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("TipoComprobanteId", TipoComprobanteId);
				com.Parameters.AddWithValue("ClienteId", ClienteId);
				...
				com.Parameters.AddWithValue("ImpuestoLocal", ImpuestoLocal);
				com.Parameters.AddWithValue("Total", Total);
				com.Parameters.AddWithValue("TotalUSD", TotalUSD);
				com.Parameters.AddWithValue("MonedaId", MonedaId);
				com.Parameters.AddWithValue("TipoCambio", TipoCambio);
				com.Parameters.AddWithValue("ObjetoImpuestoId", ObjetoImpuestoId);
				com.Parameters.AddWithValue("ObjetoImpuesto01", ObjetoImpuesto01);
				com.Parameters.AddWithValue("ObjetoImpuesto02", ObjetoImpuesto02);
				com.Parameters.AddWithValue("ObjetoImpuesto03", ObjetoImpuesto03);
				com.Parameters.AddWithValue("ObjetoImpuesto04", ObjetoImpuesto04);
				com.Parameters.AddWithValue("FormaPagoId", FormaPagoId);
				com.Parameters.AddWithValue("MetodoPagoId", MetodoPagoId);
				com.Parameters.AddWithValue("UUID", UUID);
				com.Parameters.AddWithValue("Concepto", Concepto);
				...
				com.Parameters.AddWithValue("UsoCFDI", UsoCFDI);
				com.Parameters.AddWithValue("Ruta", Ruta);
				com.Parameters.AddWithValue("VersionCFDIId", VersionCFDIId);
				com.Parameters.AddWithValue("UsuarioId", UsuarioId);
				SqlParameter parm = new SqlParameter("Id", Id);
				parm.Direction = ParameterDirection.InputOutput;
				com.Parameters.Add(parm);
		...
		public int agregaComprobanteFiscalDatosAdicionales(int ComprobanteFiscalId, string Factura, DateTime Fecha, decimal TipoEstructuraImpuestoId, decimal ObjetoImpuestoDRId, decimal BaseDR, decimal TasaOCuotaDR, int TipoFactorId, decimal TipoImpuestoDRId, decimal ImporteDR)
		{
			try
			{
				int Id = 0;
				com = new SqlCommand("[insAgregaComprobanteFiscalDatosAdicionales]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("ComprobanteFiscalId", ComprobanteFiscalId);
				com.Parameters.AddWithValue("TipoEstructuraImpuestoId", TipoEstructuraImpuestoId);
				com.Parameters.AddWithValue("ObjetoImpuestoDRId", ObjetoImpuestoDRId);
				com.Parameters.AddWithValue("Factura", Factura);
				com.Parameters.AddWithValue("Fecha", Fecha);
				com.Parameters.AddWithValue("BaseDR", BaseDR);
				com.Parameters.AddWithValue("TipoImpuestoDRId", TipoImpuestoDRId);
				com.Parameters.AddWithValue("TipoFactorDRId", TipoFactorId);
				com.Parameters.AddWithValue("TasaOCuotaDR", TasaOCuotaDR);
				com.Parameters.AddWithValue("ImporteDR", ImporteDR);
				SqlParameter parm = new SqlParameter("Id", Id);
				parm.Direction = ParameterDirection.InputOutput;
				com.Parameters.Add(parm);
				con.Open();
		...
		public int agregaComprobanteFiscalEgreso(int EmpresaId, int TipoComprobanteId, int ProveedorId, string SerieFactura, string NumeroFactura, DateTime Fecha, decimal IVARetenido, decimal ISRRetenido, decimal IVA, decimal IEPS, decimal SubTotal, decimal SubTotal0, decimal Total, int MonedaId, int FormaPagoId, int MetodoPagoId, string UUID, string Concepto, int FacturaRelacionadaId, string UUIDRelacionado, int TipoRelacionFacturaId, DateTime FechaPago, string Ruta, int UsuarioId)
		{
			try
			{
				int Id = 0;
				com = new SqlCommand("[insAgregaComprobanteFiscalEgresoSinPDFXML]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("TipoComprobanteId", TipoComprobanteId);
		...
		public int agregaComprobanteFiscalEgresoNeue(int EmpresaId, int TipoComprobanteId, int ProveedorId, string SerieFactura, string NumeroFactura, DateTime Fecha, decimal IVARetenido, decimal ISRRetenido, decimal IVA, decimal IEPS, decimal SubTotal, decimal Descuento, decimal Total, decimal TotalUSD, int MonedaId, decimal TipoCambio, int ObjetoImpuestoId, decimal ObjetoImpuesto01, decimal ObjetoImpuesto02, decimal ObjetoImpuesto03, int FormaPagoId, int MetodoPagoId, string UUID, string Concepto, int FacturaRelacionadaId, string UUIDRelacionado, int TipoRelacionFacturaId, DateTime FechaPago, string UsoCFDI, string Ruta, int VersionCFDIId, int UsuarioId)
		{
			try
			{
				int Id = 0;
				com = new SqlCommand("insAgregaComprobanteFiscalEgresoNeue40", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("EmpresaId", EmpresaId);
				com.Parameters.AddWithValue("TipoComprobanteId", TipoComprobanteId);
				com.Parameters.AddWithValue("ProveedorId", ProveedorId);
		...
		public int agregaComprobanteFiscalEgresosDatosAdicionales(int ComprobanteFiscalId, string Factura, DateTime Fecha, decimal TipoEstructuraImpuestoId, decimal ObjetoImpuestoDRId, decimal BaseDR, decimal TasaOCuotaDR, int TipoFactorId, decimal TipoImpuestoDRId, decimal ImporteDR)
		{
			try
			{
				int Id = 0;
				com = new SqlCommand("[insAgregaComprobanteFiscalEgresosDatosAdicionales]", con);
				com.CommandType = CommandType.StoredProcedure;
				com.Parameters.AddWithValue("ComprobanteFiscalId", ComprobanteFiscalId);
				com.Parameters.AddWithValue("TipoEstructuraImpuestoId", TipoEstructuraImpuestoId);
				com.Parameters.AddWithValue("ObjetoImpuestoDRId", ObjetoImpuestoDRId);

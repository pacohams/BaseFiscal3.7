...
{
	public class AgregaDeposito : FormBase
	{
		...
		public AgregaDeposito(DateTime FechaInicioPeriodo)
		{
			InitializeComponent();
		...
		private void btnAgregaDeposito_Click(object sender, EventArgs e)
		{
			try
			{
				...
				SeleccionaRelacion vSelFac = new SeleccionaRelacion(deposito, deposito.TipoComprobanteId);
				if (vSelFac.ShowDialog() == DialogResult.OK)
				{
					...
					if (deposito.TipoComprobanteId == 1 || deposito.TipoComprobanteId == 17)
					{
						...
						if (totalDeposito > 0m)
						{
							...
							SeleccionaRelacion vSelAnt = new SeleccionaRelacion(deposito, true, totalDeposito);
							if (vSelAnt.ShowDialog() == DialogResult.OK)
							{
								deposito.NumeroFactura += " | ANT.";
					...
					else if (deposito.TipoComprobanteId == 7)
					{
		...
		private void InitializeComponent()
		{
			...
			base.Name = "AgregaDeposito";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Agregar Depósitos";

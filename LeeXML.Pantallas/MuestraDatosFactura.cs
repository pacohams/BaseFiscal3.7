...
{
	public class MuestraDatosFactura : FormBase
	{
		...
		private DataGridViewTextBoxColumn EmisorRFC;

		private DataGridViewTextBoxColumn EmisorNombre;
		...
		public EntFactura FacturaAnticipo
		{
			get
			{
				...
				entFactura.TipoComprobanteId = 6;
				...
				entFactura.Descripcion = "ANTICIPO DE CLIENTE";
				entFactura.Nombre = "";
				entFactura.RFC = "";
				entFactura.UsoCFDI = "";
		...
		public MuestraDatosFactura(EntEstadoDeCuenta Deposito, int TipoMovimientoId)
		{
			InitializeComponent();
		...
		public MuestraDatosFactura(EntEstadoDeCuenta Deposito, bool Anticipo, decimal Total)
		{
			InitializeComponent();
			this.Deposito = Deposito;
			this.Total = Total;
			CargaTiposMovimientos(7);
			cmbTiposRelacion.Enabled = false;
			this.Anticipo = Anticipo;
		}

		public void CargaTiposMovimientos(int TipoMovimientoId)
		{
			cmbTiposRelacion.DataSource = new BusEmpresas().ObtieneTiposMovimientos(Program.EmpresaSeleccionada.Id);
			cmbTiposRelacion.SelectedIndex = TipoMovimientoId - 1;
		}

		private void CargaPuePPD(List<EntFactura> ListaFacturas, bool PUE)
		{
			if (PUE)
			{
		...
		private void CargaPuePpdNc(List<EntFactura> ListaFacturas, int TipoId)
		{
			if (TipoId == 1)
			{
				gvFacturas.DataSource = ListaFacturas.Where((EntFactura P) => (P.TipoComprobanteId == 1 && P.MetodoPagoId == 1) || P.TipoComprobanteId == 5).ToList();
		...
		private void SeleccionEmpresa_Load(object sender, EventArgs e)
		{
			try
			{
				if (!Anticipo)
				{
					ListaFacturas = (from P in new BusFacturas().ObtieneComprobantesFiscalesPorDepositar(Program.EmpresaSeleccionada, new DateTime(1900, 1, 1), ObtieneFechaUltimoDiaMes(Deposito.Fecha))
						where P.TotalUSD == 0m
						select P).ToList();
					ListaFacturasNcDevoluciones = (from P in new BusFacturas().ObtieneComprobantesFiscalesEgresosNcDevolucionPorDepositar(Program.EmpresaSeleccionada, new DateTime(1900, 1, 1), ObtieneFechaUltimoDiaMes(Deposito.Fecha))
						where P.TotalUSD == 0m
						select P).ToList();
					CargaPuePpdNc(ListaFacturas, ConvierteTextoAInteger(rdoPueCP.Tag.ToString()));
		...
		private void cmbTiposRelacion_SelectedIndexChanged(object sender, EventArgs e)
		{
			try
			{
				if (cmbTiposRelacion.SelectedIndex > 0)
				{
					...
					if (cmbTiposRelacion.SelectedIndex + 1 == 7)
					{
		...
		private void btnFiltraFacturas_Click(object sender, EventArgs e)
		{
			try
			{
				if (rdoPueCP.Checked)
				{
					CargaPuePpdNc(ListaFacturas.Where((EntFactura P) => P.Folio.ToUpper().Contains(txtFacturaFiltro.Text.ToUpper()) && P.UUID.ToUpper().Contains(txtUUIDfiltro.Text.ToUpper()) && P.Nombre.ToUpper().Contains(txtCliente.Text.ToUpper()) && P.Descripcion.ToUpper().Contains(txtDescripcion.Text.ToUpper())).ToList(), ConvierteTextoAInteger(rdoPueCP.Tag.ToString()));
				}
				else if (rdoPPD.Checked)
				{
					CargaPuePpdNc(ListaFacturas.Where((EntFactura P) => P.Folio.ToUpper().Contains(txtFacturaFiltro.Text.ToUpper()) && P.UUID.ToUpper().Contains(txtUUIDfiltro.Text.ToUpper()) && P.Nombre.ToUpper().Contains(txtCliente.Text.ToUpper()) && P.Descripcion.ToUpper().Contains(txtDescripcion.Text.ToUpper())).ToList(), ConvierteTextoAInteger(rdoPPD.Tag.ToString()));
				}
				else
				{
					CargaPuePpdNc(ListaFacturasNcDevoluciones.Where((EntFactura P) => P.Folio.ToUpper().Contains(txtFacturaFiltro.Text.ToUpper()) && P.UUID.ToUpper().Contains(txtUUIDfiltro.Text.ToUpper()) && P.EmisorNombre.ToUpper().Contains(txtCliente.Text.ToUpper()) && P.Descripcion.ToUpper().Contains(txtDescripcion.Text.ToUpper())).ToList(), ConvierteTextoAInteger(rdoNcDevoluciones.Tag.ToString()));
				}
			}
			catch (Exception ex)
			{
		...
		private void rdoPPD_CheckedChanged(object sender, EventArgs e)
		{
			try
			{
				if (((RadioButton)sender).Checked)
				{
					CargaPuePpdNc(ListaFacturas, ConvierteTextoAInteger(rdoPPD.Tag.ToString()));
				}
			}
			catch (Exception ex)
			{
		...
		private void rdoNcDevoluciones_CheckedChanged(object sender, EventArgs e)
		{
			try
			{
				if (((RadioButton)sender).Checked)
				{
					CargaPuePpdNc(ListaFacturasNcDevoluciones, ConvierteTextoAInteger(rdoNcDevoluciones.Tag.ToString()));
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LeeXML.Pantallas.SeleccionaRelacion));
			...
			this.btnCancelar.Location = new System.Drawing.Point(670, 2);
			...
			this.btnAgregar.Location = new System.Drawing.Point(502, 2);
			...
			this.flowLayoutPanel1.Size = new System.Drawing.Size(1297, 895);
			...
			this.cmbTiposRelacion.Size = new System.Drawing.Size(324, 30);
			...
			this.pnlAnticipo.Size = new System.Drawing.Size(977, 168);
			this.pnlAnticipo.TabIndex = 96;
			this.pnlAnticipo.Visible = false;
			this.txtTotal.Location = new System.Drawing.Point(524, 138);
			...
			this.label7.Location = new System.Drawing.Point(477, 142);
			...
			this.pnlRetenciones.Location = new System.Drawing.Point(300, 68);
			...
			this.pnlFiltro.Size = new System.Drawing.Size(1294, 38);
			this.pnlFiltro.TabIndex = 1;
			this.label8.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.label8.AutoSize = true;
			this.label8.Location = new System.Drawing.Point(890, 11);
			this.label8.Name = "label8";
			this.label8.Size = new System.Drawing.Size(72, 17);
			this.label8.TabIndex = 137;
			this.label8.Text = "Concepto:";
			this.txtDescripcion.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.txtDescripcion.Location = new System.Drawing.Point(966, 8);
			...
			this.lbNombreFiltro.Location = new System.Drawing.Point(581, 5);
			this.lbNombreFiltro.Name = "lbNombreFiltro";
			this.lbNombreFiltro.Size = new System.Drawing.Size(79, 34);
			this.lbNombreFiltro.TabIndex = 135;
			this.lbNombreFiltro.Text = "Nombre Receptor:";
			this.txtCliente.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.txtCliente.Location = new System.Drawing.Point(663, 8);
			...
			this.txtUUIDfiltro.Size = new System.Drawing.Size(354, 22);
			...
			this.btnFiltraFacturas.Location = new System.Drawing.Point(1238, 0);
			...
			this.rdoPPD.Location = new System.Drawing.Point(135, 9);
			...
			this.gvFacturas.Size = new System.Drawing.Size(1292, 472);
			...
			this.dataGridViewTextBoxColumn5.HeaderText = "RFC Receptor";
			...
			this.dataGridViewTextBoxColumn6.HeaderText = "Nombre Receptor";
			this.dataGridViewTextBoxColumn6.MinimumWidth = 6;
			this.dataGridViewTextBoxColumn6.Name = "dataGridViewTextBoxColumn6";
			this.dataGridViewTextBoxColumn6.ReadOnly = true;
			this.EmisorRFC.DataPropertyName = "EmisorRFC";
			this.EmisorRFC.FillWeight = 150f;
			this.EmisorRFC.HeaderText = "RFC Emisor";
			this.EmisorRFC.MinimumWidth = 6;
			this.EmisorRFC.Name = "EmisorRFC";
			this.EmisorRFC.ReadOnly = true;
			this.EmisorNombre.DataPropertyName = "EmisorNombre";
			this.EmisorNombre.FillWeight = 250f;
			this.EmisorNombre.HeaderText = "Nombre Emisor";
			this.EmisorNombre.MinimumWidth = 6;
			...
			this.pnlBotones.Location = new System.Drawing.Point(3, 779);
			this.pnlBotones.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.pnlBotones.Name = "pnlBotones";
			this.pnlBotones.Size = new System.Drawing.Size(1290, 86);
			this.pnlBotones.TabIndex = 94;
			base.AutoScaleDimensions = new System.Drawing.SizeF(8f, 16f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.BackColor = System.Drawing.SystemColors.ButtonHighlight;
			base.ClientSize = new System.Drawing.Size(1321, 911);
			base.Controls.Add(this.flowLayoutPanel1);
			base.FormBorderStyle = System.Windows.Forms.FormBorderStyle.SizableToolWindow;
			base.Margin = new System.Windows.Forms.Padding(4);
			base.Name = "SeleccionaRelacion";

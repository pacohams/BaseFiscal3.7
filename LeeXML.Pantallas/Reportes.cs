...
{
	public class Reportes : FormBase
	{
		...
		private CheckBox chkIngresosFiltro;

		private CheckBox chkCPFiltro;

		private CheckBox chkNominaFiltro;

		private CheckBox chkNotasCreditoFiltro;

		private CheckBox chkCanceladasFiltro;
		...
		private Button btnEnviarAExcelIngresos;

		private FlowLayoutPanel flowLayoutPanel11;

		private Button btnEnviarAExcelCP;

		private FlowLayoutPanel flowLayoutPanel12;

		private Button btnEnviarAExcelNC;
		...
		private Button btnEnviaAexcelNomina;
		...
		private Button btnAnalisisDetalleNomina;
		...
		private DataGridViewTextBoxColumn gvColumnBase;
		...
		{
			ListaComprobantes = new BusFacturas().ObtieneComprobantesFiscales(Empresa, FechaDesde, FechaHasta);
		...
		{
			GridViewMuestra.DataSource = ListaComprobantes.Where((EntFactura P) => P.Folio.ToUpper().Contains(txtFacturaFiltro.Text.ToUpper()) && P.UUID.ToUpper().Contains(txtUUIDfiltro.Text.ToUpper()) && P.RFC.ToUpper().Contains(txtRFCFiltro.Text.ToUpper()) && P.Nombre.ToUpper().Contains(txtCliente.Text.ToUpper())).ToList();
		...
		private void FiltraComprobantes(List<EntFactura> ListaComprobantes, int TipoComprobanteId, bool PUE, bool PPD, int EstatusId, DataGridView GridViewMuestra, TextBox TxtMuestraImporte, TextBox TxtMuestraSubtotal, TextBox TxtMuestraIVA, TextBox TxtMuestraNum, TextBox TxtMuestraImporteUSD, TextBox TxtMuestraSubtotalUSD, TextBox TxtMuestraIVAUSD, TextBox TxtMuestraNumUSD)
		{
			...
			GridViewMuestra.DataSource = (from P in lstFiltro
				where P.Folio.ToUpper().Contains(txtFacturaFiltro.Text.ToUpper()) && P.UUID.ToUpper().Contains(txtUUIDfiltro.Text.ToUpper()) && P.RFC.ToUpper().Contains(txtRFCFiltro.Text.ToUpper()) && P.Nombre.ToUpper().Contains(txtCliente.Text.ToUpper())
		...
		private void FiltraComprobantes(List<EntFactura> ListaComprobantes, int TipoComprobanteId, int EstatusId, DataGridView GridViewMuestra, TextBox TxtMuestraImporte, TextBox TxtMuestraSubtotal, TextBox TxtMuestraIVA, TextBox TxtMuestraNum)
		{
			...
			GridViewMuestra.DataSource = lstFiltro.Where((EntFactura P) => P.Folio.ToUpper().Contains(txtFacturaFiltro.Text.ToUpper()) && P.UUID.ToUpper().Contains(txtUUIDfiltro.Text.ToUpper()) && P.RFC.ToUpper().Contains(txtRFCFiltro.Text.ToUpper()) && P.Nombre.ToUpper().Contains(txtCliente.Text.ToUpper())).ToList();
			GridViewMuestra.Refresh();
		...
		private void btnMarcarCancelada_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					new BusFacturas().ActualizaEstatusComprobanteFiscal(f.Id, 2);
				}
		...
		private void btnMarcarVigente_Click(object sender, EventArgs e)
		{
			try
			{
				...
				foreach (EntFactura f in lstFacturasSeleccionadas)
				{
					new BusFacturas().ActualizaEstatusComprobanteFiscal(f.Id, 1);
				}
		...
		private void btnEnviarAExcelIngresos_Click(object sender, EventArgs e)
		{
			try
			{
				...
				case 2:
					...
					break;
				case 3:
					xmls = ObtieneListaFacturasFromGV(gvNominas);
					break;
				case 4:
				...
				if (tcReportesIngresos.SelectedIndex == 3)
				{
					ImprimeCFDIsNomina vImprime = new ImprimeCFDIsNomina(xmls);
					vImprime.Show();
				}
				else
				{
					ImprimeCFDIs vImprime2 = new ImprimeCFDIs(xmls);
					vImprime2.Show();
				}
			}
			catch (Exception ex)
		...
		private void btnRevisarAnticiposDepositosPrevios_Click(object sender, EventArgs e)
		{
			try
			{
				...
				int cantFacturasConAnt = RevisaAnticipoComprobantes(new BusFacturas().ObtieneComprobantesFiscales(Program.EmpresaSeleccionada, FechaDesdeFromComboBoxs(cmbMesesComprobantes, cmbAñoComprobantes), FechaHastaFromComboBoxs(cmbMesesComprobantes, cmbAñoComprobantes), 1));
		...
		private void btnFiltraFacturas_Click(object sender, EventArgs e)
		{
			try
			{
				...
				FiltraComprobantes(ListaComprobantes, 5, 1, gvComplementos, tstImporteCP.TextBox, tstSubCP.TextBox, tstIvaCP.TextBox, tstNumCP.TextBox);
				FiltraComprobantes(ListaComprobantes, 4, 1, gvNominas, tstImporteNom.TextBox, tstSubNom.TextBox, tstIvaNom.TextBox, tstNumNom.TextBox);
				FiltraComprobantes(ListaComprobantes, 2, 1, gvNotasCredito, tstImporteNC.TextBox, tstSubNC.TextBox, tstIvaNC.TextBox, tstNumNC.TextBox);
				FiltraComprobantes(ListaComprobantes.Where((EntFactura P) => P.EstatusId == 2).ToList(), gvCancelados, tstImporteCancelados.TextBox, tstSubCancelados.TextBox, tstIvaCancelados.TextBox, tstNumCancelados.TextBox);
			}
		...
		private void btnAnalisisDetalleNomina_Click(object sender, EventArgs e)
		{
			try
			{
				DateTime fechaDesde = DateTime.Today;
				...
				ReportesISR vImprime = new ReportesISR(fechaDesde, fechaHasta);
				vImprime.Show();
			}
			catch (Exception ex)
			{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LeeXML.Pantallas.Reportes));
			...
			this.gvColumnBase = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.btnEnviaAexcelNomina = new System.Windows.Forms.Button();
			this.btnAnalisisDetalleNomina = new System.Windows.Forms.Button();
			...
			this.btnBuscaEmpresa.Location = new System.Drawing.Point(753, 9);
			...
			this.cmbEmpresas.Location = new System.Drawing.Point(236, 14);
			this.cmbEmpresas.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cmbEmpresas.Name = "cmbEmpresas";
			this.cmbEmpresas.Size = new System.Drawing.Size(511, 33);
			...
			this.tcPedidosGrids.Size = new System.Drawing.Size(960, 662);
			...
			this.tabPage1.Size = new System.Drawing.Size(952, 627);
			this.tabPage1.TabIndex = 0;
			this.tabPage1.Text = "Comprobantes Fiscales Emitidos";
			...
			this.pnlFiltro.Location = new System.Drawing.Point(9, 138);
			this.pnlFiltro.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.pnlFiltro.Name = "pnlFiltro";
			this.pnlFiltro.Size = new System.Drawing.Size(1256, 47);
			this.pnlFiltro.TabIndex = 138;
			...
			this.txtCliente.Location = new System.Drawing.Point(304, 9);
			...
			this.txtUUIDfiltro.Location = new System.Drawing.Point(574, 9);
			...
			this.btnFiltraFacturas.Location = new System.Drawing.Point(1191, 0);
			...
			this.txtFacturaFiltro.Location = new System.Drawing.Point(1042, 9);
			...
			this.tcReportesIngresos.Location = new System.Drawing.Point(9, 192);
			...
			this.tcReportesIngresos.Size = new System.Drawing.Size(950, 402);
			...
			this.tabPage2.Size = new System.Drawing.Size(942, 367);
			...
			this.flpTotalesTodos.Location = new System.Drawing.Point(532, 314);
			...
			this.tstxtNum.Size = new System.Drawing.Size(22, 31);
			...
			this.gvXMLs.Columns.AddRange(this.rFCDataGridViewTextBoxColumn, this.nombreDataGridViewTextBoxColumn, this.uUIDDataGridViewTextBoxColumn, this.folioDataGridViewTextBoxColumn, this.subTotalDataGridViewTextBoxColumn, this.descuentoDataGridViewTextBoxColumn, this.iVADataGridViewTextBoxColumn, this.retencionesDataGridViewTextBoxColumn, this.totalDataGridViewTextBoxColumn, this.dataGridViewTextBoxColumn79, this.dataGridViewTextBoxColumn80, this.fechaDataGridViewTextBoxColumn, this.TipoComprobante, this.MetodoPago, this.FormaPago, this.UUIDrelacionado, this.Descripcion, this.EstatusDescripcion);
			this.gvXMLs.DataSource = this.entFacturaBindingSource;
			this.gvXMLs.Location = new System.Drawing.Point(0, 45);
			...
			dataGridViewCellStyle9.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle9.ForeColor = System.Drawing.Color.Black;
			this.gvXMLs.RowsDefaultCellStyle = dataGridViewCellStyle9;
			...
			this.gvXMLs.Size = new System.Drawing.Size(831, 266);
			...
			this.folioDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle10;
			...
			this.subTotalDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle11;
			...
			this.iVADataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle13;
			...
			this.retencionesDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle14;
			...
			this.dataGridViewTextBoxColumn79.DataPropertyName = "Moneda";
			this.dataGridViewTextBoxColumn79.FillWeight = 50f;
			this.dataGridViewTextBoxColumn79.HeaderText = "Moneda";
			this.dataGridViewTextBoxColumn79.MinimumWidth = 6;
			this.dataGridViewTextBoxColumn79.Name = "dataGridViewTextBoxColumn79";
			this.dataGridViewTextBoxColumn79.ReadOnly = true;
			this.dataGridViewTextBoxColumn80.DataPropertyName = "TipoCambio";
			this.dataGridViewTextBoxColumn80.FillWeight = 50f;
			this.dataGridViewTextBoxColumn80.HeaderText = "Tipo Cambio";
			...
			this.MetodoPago.DefaultCellStyle = dataGridViewCellStyle16;
			...
			this.flowLayoutPanel1.Location = new System.Drawing.Point(828, 40);
			...
			this.btnMarcarCancelada.Image = LeeXML.Properties.Resources.Eliminar;
			...
			this.flowLayoutPanel2.Location = new System.Drawing.Point(-21, 2);
			this.flowLayoutPanel2.Margin = new System.Windows.Forms.Padding(2);
			this.flowLayoutPanel2.Name = "flowLayoutPanel2";
			this.flowLayoutPanel2.Padding = new System.Windows.Forms.Padding(6, 8, 0, 0);
			this.flowLayoutPanel2.Size = new System.Drawing.Size(851, 44);
			this.flowLayoutPanel2.TabIndex = 136;
			this.chkCanceladasFiltro.AutoSize = true;
			this.chkCanceladasFiltro.Location = new System.Drawing.Point(715, 10);
			this.chkCanceladasFiltro.Margin = new System.Windows.Forms.Padding(2);
			...
			this.chkNotasCreditoFiltro.Location = new System.Drawing.Point(609, 10);
			this.chkNotasCreditoFiltro.Margin = new System.Windows.Forms.Padding(2);
			...
			this.chkNominaFiltro.Location = new System.Drawing.Point(493, 10);
			this.chkNominaFiltro.Margin = new System.Windows.Forms.Padding(2);
			...
			this.chkCPFiltro.Location = new System.Drawing.Point(311, 10);
			this.chkCPFiltro.Margin = new System.Windows.Forms.Padding(2);
			...
			this.chkIngresosFiltro.Location = new System.Drawing.Point(203, 10);
			this.chkIngresosFiltro.Margin = new System.Windows.Forms.Padding(2);
			...
			this.flowLayoutPanel14.Location = new System.Drawing.Point(828, 145);
			...
			this.tpIngresos.Margin = new System.Windows.Forms.Padding(2);
			this.tpIngresos.Name = "tpIngresos";
			this.tpIngresos.Padding = new System.Windows.Forms.Padding(2);
			this.tpIngresos.Size = new System.Drawing.Size(942, 367);
			...
			this.flowLayoutPanel3.Location = new System.Drawing.Point(-208, 275);
			this.flowLayoutPanel3.Margin = new System.Windows.Forms.Padding(2);
			this.flowLayoutPanel3.Name = "flowLayoutPanel3";
			this.flowLayoutPanel3.Padding = new System.Windows.Forms.Padding(0, 2, 0, 0);
			this.flowLayoutPanel3.Size = new System.Drawing.Size(1040, 36);
			...
			this.toolStrip2.Size = new System.Drawing.Size(834, 31);
			...
			this.tstImporteIngresos.Size = new System.Drawing.Size(48, 31);
			...
			this.flowLayoutPanel16.Location = new System.Drawing.Point(-208, 314);
			...
			this.flowLayoutPanel16.Size = new System.Drawing.Size(1040, 36);
			this.flowLayoutPanel16.TabIndex = 138;
			...
			this.toolStrip7.Size = new System.Drawing.Size(829, 31);
			...
			this.tstImporteIngresosUSD.Size = new System.Drawing.Size(48, 31);
			...
			dataGridViewCellStyle17.ForeColor = System.Drawing.Color.FromArgb(64, 64, 64);
			this.gvIngresos.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle17;
			...
			this.gvIngresos.Columns.AddRange(this.dataGridViewTextBoxColumn1, this.dataGridViewTextBoxColumn2, this.dataGridViewTextBoxColumn3, this.dataGridViewTextBoxColumn4, this.dataGridViewTextBoxColumn5, this.dataGridViewTextBoxColumn6, this.gvColumnBase, this.dataGridViewTextBoxColumn7, this.IEPS, this.dataGridViewTextBoxColumn8, this.dataGridViewTextBoxColumn9, this.Moneda, this.TipoCambio, this.dataGridViewTextBoxColumn10, this.dataGridViewTextBoxColumn11, this.dataGridViewTextBoxColumn12, this.dataGridViewTextBoxColumn13, this.dataGridViewTextBoxColumn14, this.dataGridViewTextBoxColumn15);
			this.gvIngresos.DataSource = this.entFacturaBindingSource;
			this.gvIngresos.Location = new System.Drawing.Point(0, 46);
			...
			dataGridViewCellStyle21.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle21.ForeColor = System.Drawing.Color.Black;
			this.gvIngresos.RowsDefaultCellStyle = dataGridViewCellStyle21;
			this.gvIngresos.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.gvIngresos.Size = new System.Drawing.Size(834, 228);
			this.gvIngresos.TabIndex = 136;
			this.gvIngresos.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(gvXMLs_CellDoubleClick);
			...
			this.gvColumnBase.DataPropertyName = "SubTotal";
			dataGridViewCellStyle25.Format = "c2";
			this.gvColumnBase.DefaultCellStyle = dataGridViewCellStyle25;
			this.gvColumnBase.HeaderText = "Base";
			this.gvColumnBase.MinimumWidth = 6;
			this.gvColumnBase.Name = "gvColumnBase";
			this.gvColumnBase.ReadOnly = true;
			...
			this.IEPS.DefaultCellStyle = dataGridViewCellStyle27;
			...
			this.TipoCambio.DefaultCellStyle = dataGridViewCellStyle30;
			...
			this.dataGridViewTextBoxColumn11.DataPropertyName = "TipoComprobante";
			this.dataGridViewTextBoxColumn11.HeaderText = "Tipo Comprobante";
			this.dataGridViewTextBoxColumn11.MinimumWidth = 6;
			this.dataGridViewTextBoxColumn11.Name = "dataGridViewTextBoxColumn11";
			this.dataGridViewTextBoxColumn11.ReadOnly = true;
			this.dataGridViewTextBoxColumn12.DataPropertyName = "MetodoPago";
			...
			this.dataGridViewTextBoxColumn12.HeaderText = "Metodo Pago";
			this.dataGridViewTextBoxColumn12.MinimumWidth = 6;
			this.dataGridViewTextBoxColumn12.Name = "dataGridViewTextBoxColumn12";
			this.dataGridViewTextBoxColumn12.ReadOnly = true;
			this.dataGridViewTextBoxColumn13.DataPropertyName = "FormaPago";
			this.dataGridViewTextBoxColumn13.FillWeight = 120f;
			this.dataGridViewTextBoxColumn13.HeaderText = "Forma Pago";
			this.dataGridViewTextBoxColumn13.MinimumWidth = 6;
			this.dataGridViewTextBoxColumn13.Name = "dataGridViewTextBoxColumn13";
			this.dataGridViewTextBoxColumn13.ReadOnly = true;
			this.dataGridViewTextBoxColumn14.DataPropertyName = "UUIDrelacionado";
			this.dataGridViewTextBoxColumn14.HeaderText = "UUIDrelacionado";
			this.dataGridViewTextBoxColumn14.MinimumWidth = 6;
			this.dataGridViewTextBoxColumn14.Name = "dataGridViewTextBoxColumn14";
			this.dataGridViewTextBoxColumn14.ReadOnly = true;
			this.dataGridViewTextBoxColumn15.DataPropertyName = "Descripcion";
			this.dataGridViewTextBoxColumn15.HeaderText = "Concepto";
			...
			this.flowLayoutPanel10.Location = new System.Drawing.Point(831, 38);
			this.flowLayoutPanel10.Margin = new System.Windows.Forms.Padding(2);
			this.flowLayoutPanel10.Name = "flowLayoutPanel10";
			this.flowLayoutPanel10.Size = new System.Drawing.Size(120, 300);
			...
			this.pnlFiltroPUEPPD.Location = new System.Drawing.Point(2, 0);
			...
			this.pnlFiltroPUEPPD.TabIndex = 139;
			this.rdoTodas.AutoSize = true;
			this.rdoTodas.Checked = true;
			this.rdoTodas.Location = new System.Drawing.Point(15, 9);
			this.rdoTodas.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			this.rdoPPD.Location = new System.Drawing.Point(315, 9);
			this.rdoPPD.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			this.rdoPueCP.Location = new System.Drawing.Point(159, 9);
			this.rdoPueCP.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			this.tabPage3.Size = new System.Drawing.Size(942, 367);
			...
			this.flowLayoutPanel17.Location = new System.Drawing.Point(291, 314);
			...
			this.flowLayoutPanel17.TabIndex = 141;
			...
			this.toolStripLabel32.Size = new System.Drawing.Size(84, 27);
			this.toolStripLabel32.Text = "SubTotal:";
			this.toolStripLabel32.Visible = false;
			this.toolStripTextBox2.Font = new System.Drawing.Font("Segoe UI", 9f);
			this.toolStripTextBox2.Name = "toolStripTextBox2";
			this.toolStripTextBox2.ReadOnly = true;
			this.toolStripTextBox2.Size = new System.Drawing.Size(43, 32);
			...
			this.toolStripLabel33.Size = new System.Drawing.Size(52, 27);
			this.toolStripLabel33.Text = "I.V.A:";
			this.toolStripLabel33.Visible = false;
			this.toolStripTextBox3.Font = new System.Drawing.Font("Segoe UI", 9f);
			this.toolStripTextBox3.Name = "toolStripTextBox3";
			this.toolStripTextBox3.ReadOnly = true;
			this.toolStripTextBox3.Size = new System.Drawing.Size(73, 32);
			...
			dataGridViewCellStyle32.BackColor = System.Drawing.Color.FromArgb(192, 192, 255);
			dataGridViewCellStyle32.Font = new System.Drawing.Font("Microsoft Sans Serif", 6.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle32.ForeColor = System.Drawing.Color.FromArgb(64, 64, 64);
			this.gvComplementos.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle32;
			...
			dataGridViewCellStyle33.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle33.ForeColor = System.Drawing.Color.Black;
			this.gvComplementos.RowsDefaultCellStyle = dataGridViewCellStyle33;
			this.gvComplementos.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.gvComplementos.Size = new System.Drawing.Size(834, 228);
			this.gvComplementos.TabIndex = 138;
			this.gvComplementos.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(gvXMLs_CellDoubleClick);
			this.dataGridViewTextBoxColumn16.DataPropertyName = "RFC";
			...
			dataGridViewCellStyle35.Format = "c4";
			...
			dataGridViewCellStyle37.Format = "c4";
			...
			this.dataGridViewTextBoxColumn29.DefaultCellStyle = dataGridViewCellStyle40;
			this.dataGridViewTextBoxColumn29.FillWeight = 50f;
			this.dataGridViewTextBoxColumn29.HeaderText = "Metodo Pago";
			...
			this.dataGridViewTextBoxColumn77.HeaderText = "UUIDrelacionado";
			...
			this.flowLayoutPanel4.Location = new System.Drawing.Point(291, 274);
			...
			this.tstSubCP.Size = new System.Drawing.Size(43, 32);
			...
			this.tstIvaCP.Size = new System.Drawing.Size(73, 32);
			...
			this.flowLayoutPanel11.Location = new System.Drawing.Point(830, 38);
			...
			this.tabPage4.Controls.Add(this.flowLayoutPanel15);
			this.tabPage4.Controls.Add(this.flowLayoutPanel5);
			this.tabPage4.Location = new System.Drawing.Point(4, 31);
			this.tabPage4.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.tabPage4.Name = "tabPage4";
			this.tabPage4.Padding = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.tabPage4.Size = new System.Drawing.Size(942, 367);
			this.tabPage4.TabIndex = 3;
			this.tabPage4.Text = "Nóminas - N";
			this.tabPage4.UseVisualStyleBackColor = true;
			this.gvNominas.AllowUserToAddRows = false;
			dataGridViewCellStyle41.BackColor = System.Drawing.Color.FromArgb(192, 192, 255);
			dataGridViewCellStyle41.Font = new System.Drawing.Font("Microsoft Sans Serif", 6.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle41.ForeColor = System.Drawing.Color.FromArgb(64, 64, 64);
			this.gvNominas.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle41;
			...
			this.gvNominas.Columns.AddRange(this.dataGridViewTextBoxColumn31, this.dataGridViewTextBoxColumn32, this.dataGridViewTextBoxColumn33, this.dataGridViewTextBoxColumn34, this.dataGridViewTextBoxColumn35, this.dataGridViewTextBoxColumn36, this.dataGridViewTextBoxColumn37, this.dataGridViewTextBoxColumn38, this.dataGridViewTextBoxColumn39, this.TotalPercepciones, this.TotalDeducciones, this.dataGridViewTextBoxColumn40, this.dataGridViewTextBoxColumn41, this.dataGridViewTextBoxColumn42, this.dataGridViewTextBoxColumn43, this.dataGridViewTextBoxColumn44, this.dataGridViewTextBoxColumn45);
			...
			dataGridViewCellStyle42.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle42.ForeColor = System.Drawing.Color.Black;
			this.gvNominas.RowsDefaultCellStyle = dataGridViewCellStyle42;
			this.gvNominas.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.gvNominas.Size = new System.Drawing.Size(830, 260);
			this.gvNominas.TabIndex = 138;
			this.gvNominas.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(gvXMLs_CellDoubleClick);
			...
			dataGridViewCellStyle44.Format = "c4";
			...
			dataGridViewCellStyle46.Format = "c4";
			...
			dataGridViewCellStyle47.Format = "c4";
			...
			this.dataGridViewTextBoxColumn39.DefaultCellStyle = dataGridViewCellStyle48;
			...
			this.TotalPercepciones.DefaultCellStyle = dataGridViewCellStyle49;
			...
			this.dataGridViewTextBoxColumn42.DefaultCellStyle = dataGridViewCellStyle51;
			this.dataGridViewTextBoxColumn42.FillWeight = 120f;
			this.dataGridViewTextBoxColumn42.HeaderText = "Metodo Pago";
			...
			this.dataGridViewTextBoxColumn44.HeaderText = "UUIDrelacionado";
			...
			this.flowLayoutPanel15.Controls.Add(this.btnEnviaAexcelNomina);
			this.flowLayoutPanel15.Controls.Add(this.btnAnalisisDetalleNomina);
			this.flowLayoutPanel15.Location = new System.Drawing.Point(826, 38);
			this.flowLayoutPanel15.Margin = new System.Windows.Forms.Padding(2);
			this.flowLayoutPanel15.Name = "flowLayoutPanel15";
			this.flowLayoutPanel15.Size = new System.Drawing.Size(120, 300);
			this.flowLayoutPanel15.TabIndex = 141;
			this.btnEnviaAexcelNomina.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
			this.btnEnviaAexcelNomina.BackColor = System.Drawing.Color.White;
			this.btnEnviaAexcelNomina.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Center;
			this.btnEnviaAexcelNomina.Cursor = System.Windows.Forms.Cursors.Hand;
			this.btnEnviaAexcelNomina.Font = new System.Drawing.Font("Segoe UI", 7f, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0);
			this.btnEnviaAexcelNomina.Image = LeeXML.Properties.Resources.excel_logo;
			this.btnEnviaAexcelNomina.Location = new System.Drawing.Point(4, 5);
			this.btnEnviaAexcelNomina.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnEnviaAexcelNomina.Name = "btnEnviaAexcelNomina";
			this.btnEnviaAexcelNomina.Size = new System.Drawing.Size(105, 105);
			this.btnEnviaAexcelNomina.TabIndex = 133;
			this.btnEnviaAexcelNomina.Text = "Enviar a Excel";
			this.btnEnviaAexcelNomina.TextAlign = System.Drawing.ContentAlignment.BottomCenter;
			this.btnEnviaAexcelNomina.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageAboveText;
			this.btnEnviaAexcelNomina.UseVisualStyleBackColor = false;
			this.btnEnviaAexcelNomina.Click += new System.EventHandler(btnEnviarAExcelIngresos_Click);
			this.btnAnalisisDetalleNomina.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
			this.btnAnalisisDetalleNomina.BackColor = System.Drawing.Color.White;
			this.btnAnalisisDetalleNomina.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Center;
			this.btnAnalisisDetalleNomina.Cursor = System.Windows.Forms.Cursors.Hand;
			this.btnAnalisisDetalleNomina.Font = new System.Drawing.Font("Segoe UI", 6f, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0);
			this.btnAnalisisDetalleNomina.Image = LeeXML.Properties.Resources.observaciones;
			this.btnAnalisisDetalleNomina.Location = new System.Drawing.Point(4, 120);
			this.btnAnalisisDetalleNomina.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnAnalisisDetalleNomina.Name = "btnAnalisisDetalleNomina";
			this.btnAnalisisDetalleNomina.Size = new System.Drawing.Size(105, 105);
			this.btnAnalisisDetalleNomina.TabIndex = 134;
			this.btnAnalisisDetalleNomina.Text = "Ver Detalle Percepciones / Deducciones";
			this.btnAnalisisDetalleNomina.TextAlign = System.Drawing.ContentAlignment.BottomCenter;
			this.btnAnalisisDetalleNomina.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageAboveText;
			this.btnAnalisisDetalleNomina.UseVisualStyleBackColor = false;
			this.btnAnalisisDetalleNomina.Click += new System.EventHandler(btnAnalisisDetalleNomina_Click);
			...
			this.flowLayoutPanel5.Location = new System.Drawing.Point(4, 306);
			...
			this.flowLayoutPanel5.Size = new System.Drawing.Size(824, 42);
			...
			this.flowLayoutPanel8.Location = new System.Drawing.Point(521, 4);
			...
			this.toolStrip4.Location = new System.Drawing.Point(0, 2);
			this.toolStrip4.Name = "toolStrip4";
			this.toolStrip4.Padding = new System.Windows.Forms.Padding(0);
			this.toolStrip4.Size = new System.Drawing.Size(233, 31);
			...
			this.tstNumNom.Size = new System.Drawing.Size(28, 31);
			...
			this.tabPage5.Size = new System.Drawing.Size(942, 367);
			this.tabPage5.TabIndex = 4;
			this.tabPage5.Text = "Egresos - E";
			this.tabPage5.UseVisualStyleBackColor = true;
			this.gvNotasCredito.AllowUserToAddRows = false;
			dataGridViewCellStyle52.BackColor = System.Drawing.Color.FromArgb(192, 192, 255);
			dataGridViewCellStyle52.Font = new System.Drawing.Font("Microsoft Sans Serif", 6.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle52.ForeColor = System.Drawing.Color.FromArgb(64, 64, 64);
			this.gvNotasCredito.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle52;
			...
			dataGridViewCellStyle53.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			dataGridViewCellStyle53.ForeColor = System.Drawing.Color.Black;
			this.gvNotasCredito.RowsDefaultCellStyle = dataGridViewCellStyle53;
			this.gvNotasCredito.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.gvNotasCredito.Size = new System.Drawing.Size(834, 255);
			this.gvNotasCredito.TabIndex = 138;
			this.gvNotasCredito.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(gvXMLs_CellDoubleClick);
			this.dataGridViewTextBoxColumn46.DataPropertyName = "RFC";
			...
			this.dataGridViewTextBoxColumn47.DataPropertyName = "Nombre";
			...
			this.dataGridViewTextBoxColumn54.DefaultCellStyle = dataGridViewCellStyle59;
			...
			this.dataGridViewTextBoxColumn55.FillWeight = 50f;
			...
			this.dataGridViewTextBoxColumn56.FillWeight = 50f;
			...
			this.dataGridViewTextBoxColumn59.DefaultCellStyle = dataGridViewCellStyle60;
			this.dataGridViewTextBoxColumn59.FillWeight = 50f;
			this.dataGridViewTextBoxColumn59.HeaderText = "Metodo Pago";
			...
			this.dataGridViewTextBoxColumn81.HeaderText = "UUIDrelacionado";
			...
			this.flowLayoutPanel6.Location = new System.Drawing.Point(-93, 302);
			this.flowLayoutPanel6.Margin = new System.Windows.Forms.Padding(2);
			this.flowLayoutPanel6.Name = "flowLayoutPanel6";
			this.flowLayoutPanel6.Padding = new System.Windows.Forms.Padding(0, 2, 0, 0);
			...
			this.flowLayoutPanel9.Location = new System.Drawing.Point(623, 4);
			...
			this.toolStrip5.Size = new System.Drawing.Size(233, 31);
			...
			this.tstNumNC.Size = new System.Drawing.Size(28, 31);
			...
			this.flowLayoutPanel12.Location = new System.Drawing.Point(831, 38);
			...
			this.tabPage6.Size = new System.Drawing.Size(942, 367);
			...
			this.flowLayoutPanel7.Location = new System.Drawing.Point(534, 311);
			...
			this.toolStrip6.Size = new System.Drawing.Size(233, 31);
			...
			this.tstNumCancelados.Size = new System.Drawing.Size(28, 31);
			...
			this.gvCancelados.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle61;
			...
			this.gvCancelados.RowsDefaultCellStyle = dataGridViewCellStyle62;
			this.gvCancelados.RowTemplate.Height = 25;
			this.gvCancelados.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.gvCancelados.Size = new System.Drawing.Size(834, 265);
			this.gvCancelados.TabIndex = 138;
			this.gvCancelados.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(gvXMLs_CellDoubleClick);
			this.dataGridViewTextBoxColumn61.DataPropertyName = "RFC";
			...
			this.dataGridViewTextBoxColumn62.DataPropertyName = "Nombre";
			...
			this.dataGridViewTextBoxColumn64.DefaultCellStyle = dataGridViewCellStyle63;
			...
			this.dataGridViewTextBoxColumn65.DefaultCellStyle = dataGridViewCellStyle64;
			...
			this.dataGridViewTextBoxColumn66.DefaultCellStyle = dataGridViewCellStyle65;
			...
			this.dataGridViewTextBoxColumn67.DefaultCellStyle = dataGridViewCellStyle66;
			...
			this.dataGridViewTextBoxColumn68.DefaultCellStyle = dataGridViewCellStyle67;
			...
			this.dataGridViewTextBoxColumn69.DefaultCellStyle = dataGridViewCellStyle68;
			...
			this.dataGridViewTextBoxColumn71.HeaderText = "TipoComprobante";
			...
			this.dataGridViewTextBoxColumn72.DefaultCellStyle = dataGridViewCellStyle69;
			this.dataGridViewTextBoxColumn72.FillWeight = 120f;
			this.dataGridViewTextBoxColumn72.HeaderText = "MetodoPago";
			...
			this.dataGridViewTextBoxColumn73.HeaderText = "FormaPago";
			...
			this.dataGridViewTextBoxColumn74.HeaderText = "UUIDrelacionado";
			...
			this.flowLayoutPanel13.Location = new System.Drawing.Point(831, 38);
			...
			this.btnRefrescar.Location = new System.Drawing.Point(482, 5);
			...
			this.rdoPorMesComprobantes.Location = new System.Drawing.Point(12, 22);
			...
			this.pnlPorMesVentas.Location = new System.Drawing.Point(118, 6);
			...
			this.pnlPorDiaVentas.Location = new System.Drawing.Point(118, 62);
			...
			this.rdoPorFechasComprobantes.Location = new System.Drawing.Point(12, 78);
			...
			base.ClientSize = new System.Drawing.Size(992, 708);

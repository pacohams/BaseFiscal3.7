...
{
	public class ObservacionesEgresos : FormBase
	{
		...
		{
			ListaComprobantes1 = (from P in new BusFacturas().ObtieneEstadosDeCuentaDetallePorTipoComprobanteEgresos(Empresa, FechaDesde, FechaHasta, 1)
		...
		{
			ListaComprobantes2 = new BusFacturas().ObtieneComprobantesFiscalesEgresos(Empresa, 3, FechaDesde, FechaHasta).ToList();
		...
		{
			ListaComprobantes3 = (from P in new BusFacturas().ObtieneComprobantesFiscalesEgresos(Empresa, FechaDesde, FechaHasta, 1)
		...
		{
			List<EntFactura> lstCP = (from P in new BusFacturas().ObtieneComprobantesFiscalesEgresos(Empresa, FechaDesde, FechaHasta, 1)
		...
		{
			ListaComprobantes5 = new BusFacturas().ObtieneEstadosDeCuentaDetallePorTipoComprobanteEgresos(Empresa, FechaDesde, FechaHasta, 6);
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LeeXML.Pantallas.ObservacionesEgresos));
			...
			this.gbDatosGenerales.Size = new System.Drawing.Size(316, 145);
			...
			this.txtNombreFiscal.Location = new System.Drawing.Point(25, 50);
			...
			this.txtNombreFiscal.Size = new System.Drawing.Size(283, 23);
			...
			this.txtRFC.Location = new System.Drawing.Point(25, 113);
			this.txtRFC.Margin = new System.Windows.Forms.Padding(4);
			this.txtRFC.Name = "txtRFC";
			this.txtRFC.ReadOnly = true;
			this.txtRFC.Size = new System.Drawing.Size(191, 23);
			...
			this.tabPage3.Text = "1. CFDI PPD PAGADAS SIN COMPLEMENTO DE PAGO";
			...
			this.rvObservaciones.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptObservacion1Egresos.rdlc";
			...
			this.tabPage2.Size = new System.Drawing.Size(914, 536);
			this.tabPage2.TabIndex = 2;
			this.tabPage2.Text = "2. CFDI PUE NO PAGADAS";
			...
			this.rvObservaciones2.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptObservacion2Egresos.rdlc";
			...
			this.rvObservaciones2.Size = new System.Drawing.Size(914, 536);
			...
			this.tabPage4.Size = new System.Drawing.Size(914, 536);
			...
			this.rvObservaciones3.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptObservacion3Egresos.rdlc";
			...
			this.rvObservaciones3.Size = new System.Drawing.Size(914, 536);
			...
			this.tabPage5.Size = new System.Drawing.Size(914, 536);
			...
			this.rvObservaciones4.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptObservacion4Egresos.rdlc";
			...
			this.rvObservaciones4.Size = new System.Drawing.Size(914, 536);
			...
			this.tabPage7.Size = new System.Drawing.Size(914, 536);
			this.tabPage7.TabIndex = 6;
			this.tabPage7.Text = "5. ANTICIPOS A PROVEEDORES NO FACTURADOS";
			...
			this.rvObservaciones5.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptObservacion5Egresos.rdlc";
			...
			this.rvObservaciones5.Size = new System.Drawing.Size(914, 536);
			...
			base.Name = "ObservacionesEgresos";

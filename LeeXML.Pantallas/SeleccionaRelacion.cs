...
{
	public class SeleccionaRelacion : FormBase
	{
		...
		public SeleccionaRelacion(EntEstadoDeCuenta Deposito, int TipoMovimientoId)
		{
			InitializeComponent();
		...
		public SeleccionaRelacion(EntEstadoDeCuenta Deposito, bool Anticipo, decimal Total)
		{
			InitializeComponent();
			this.Deposito = Deposito;
			this.Total = Total;

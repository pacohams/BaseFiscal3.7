...
namespace LeeXML.Pantallas
{
	public class CxP : FormBase
	{
		...
		private List<EntEstadoDeCuenta> ListaCxP { get; set; }

		private List<EntEstadoDeCuenta> ListaCxPMovimientosPorFecha { get; set; }

		private List<EntEstadoDeCuenta> ListaCxPMovimientosPorFactura { get; set; }
		...
		private void CargaCxP(EntEmpresa Empresa, DateTime FechaDesde, DateTime FechaHasta, int ProveedorDesdeId, int ProveedorHastaId)
		{
			ListaCxP = new BusFacturas().ObtieneCxPPorProveedores(Empresa, FechaDesde, FechaHasta, ProveedorDesdeId, ProveedorHastaId);
			ListaCxP = ListaCxP.Where((EntEstadoDeCuenta P) => P.SubTotal0 > 0m || P.SubTotal > 0m || P.Total > 0m || P.Descuento > 0m).ToList();
			...
			EntEstadoDeCuentaBindingSource.DataSource = ListaCxP;
			rvBalanzaComprobacion.LocalReport.DataSources.Clear();
			rvBalanzaComprobacion.LocalReport.DataSources.Add(new ReportDataSource("dsBancos", (IEnumerable)ListaCxP));
			rvBalanzaComprobacion.RefreshReport();
		}

		private void CargaCxCMovimientos(EntEmpresa Empresa, DateTime FechaDesde, DateTime FechaHasta, int ProveedorDesdeId, int ProveedorHastaId)
		{
			ListaCxPMovimientosPorFecha = new BusFacturas().ObtieneCxPMovimientosPorProveedores(Empresa, FechaDesde, FechaHasta, ProveedorDesdeId, ProveedorHastaId);
			ListaCxPMovimientosPorFecha = ListaCxPMovimientosPorFecha.Where((EntEstadoDeCuenta P) => P.SubTotal0 > 0m || P.SubTotal > 0m || P.Total > 0m || P.Descuento > 0m).ToList();
			decimal saldoFinal = default(decimal);
			if (ListaCxPMovimientosPorFecha.Count > 0)
			{
				saldoFinal = ListaCxPMovimientosPorFecha.Last().Deposito;
			}
			ReportParameter parmEmpresa = new ReportParameter("parmEmpresa", " " + Empresa.Nombre);
			ReportParameter parmFecha = new ReportParameter("parmFecha", " " + FechaDesde.ToString("dd/MMM/yyyy").ToUpper() + " al " + ObtieneFechaUltimoDiaMes(FechaHasta.Month, FechaHasta.Year).ToString("dd/MMM/yyyy").ToUpper());
			...
			EntEstadoDeCuentaBindingSource.DataSource = ListaCxPMovimientosPorFecha;
			rvMovimientosAuxiliares.LocalReport.DataSources.Clear();
			rvMovimientosAuxiliares.LocalReport.DataSources.Add(new ReportDataSource("dsBancos", (IEnumerable)ListaCxPMovimientosPorFecha));
			rvMovimientosAuxiliares.RefreshReport();
			ListaCxPMovimientosPorFactura = new BusFacturas().ObtieneCxPMovimientosPorProveedoresPorFactura(Empresa, FechaDesde, FechaHasta, ProveedorDesdeId, ProveedorHastaId);
			...
			rvMovimientosAuxiliaresFactura.LocalReport.DataSources.Add(new ReportDataSource("dsBancos", (IEnumerable)ListaCxPMovimientosPorFactura));
		...
		private void btnRefrescaReporteBalanza_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					CargaCxP(Program.EmpresaSeleccionada, FechaDesdeFromComboBoxs(cmbMesesDesdeBalanza, cmbAñosDesdeBalanza), FechaHastaFromComboBoxs(cmbMesesHastaBalanza, cmbAñosHastaBalanza), ConvierteTextoAInteger(cmbClientesDesde.Text), ConvierteTextoAInteger(cmbClientesHasta.Text));
				}
				else
				{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LeeXML.Pantallas.CxP));
			...
			this.tcPedidosGrids.Size = new System.Drawing.Size(1379, 761);
			...
			this.tabPage7.Size = new System.Drawing.Size(1371, 726);
			...
			this.groupBox1.Location = new System.Drawing.Point(601, 11);
			...
			this.txtNombreFiscalBalanza.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
			this.txtNombreFiscalBalanza.Location = new System.Drawing.Point(171, 26);
			this.txtNombreFiscalBalanza.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.txtNombreFiscalBalanza.Name = "txtNombreFiscalBalanza";
			this.txtNombreFiscalBalanza.ReadOnly = true;
			this.txtNombreFiscalBalanza.Size = new System.Drawing.Size(509, 30);
			...
			this.txtRFCBalanza.Location = new System.Drawing.Point(171, 66);
			this.txtRFCBalanza.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.txtRFCBalanza.Name = "txtRFCBalanza";
			this.txtRFCBalanza.ReadOnly = true;
			this.txtRFCBalanza.Size = new System.Drawing.Size(247, 30);
			...
			this.tabControl1.Location = new System.Drawing.Point(4, 184);
			this.tabControl1.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.tabControl1.Name = "tabControl1";
			this.tabControl1.SelectedIndex = 0;
			this.tabControl1.Size = new System.Drawing.Size(1361, 532);
			...
			this.tabPage9.Size = new System.Drawing.Size(1353, 497);
			...
			this.rvBalanzaComprobacion.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptBalanzaComprobacionEgresos.rdlc";
			this.rvBalanzaComprobacion.Location = new System.Drawing.Point(0, 0);
			this.rvBalanzaComprobacion.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rvBalanzaComprobacion.Name = "rvBalanzaComprobacion";
			this.rvBalanzaComprobacion.ServerReport.BearerToken = null;
			this.rvBalanzaComprobacion.Size = new System.Drawing.Size(1351, 488);
			...
			this.tabPage10.Size = new System.Drawing.Size(1518, 497);
			this.tabPage10.TabIndex = 1;
			this.tabPage10.Text = "Movimientos Auxiliares";
			this.tabPage10.UseVisualStyleBackColor = true;
			this.rdoMovimientosAuxiliaresPorFactura.AutoSize = true;
			this.rdoMovimientosAuxiliaresPorFactura.Location = new System.Drawing.Point(188, 6);
			this.rdoMovimientosAuxiliaresPorFactura.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.rdoMovimientosAuxiliaresPorFactura.Name = "rdoMovimientosAuxiliaresPorFactura";
			this.rdoMovimientosAuxiliaresPorFactura.Size = new System.Drawing.Size(122, 26);
			...
			this.rdoMovimientosAuxiliaresPorFecha.Location = new System.Drawing.Point(7, 6);
			this.rdoMovimientosAuxiliaresPorFecha.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.rdoMovimientosAuxiliaresPorFecha.Name = "rdoMovimientosAuxiliaresPorFecha";
			this.rdoMovimientosAuxiliaresPorFecha.Size = new System.Drawing.Size(110, 26);
			...
			this.rvMovimientosAuxiliares.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptMovimientosAuxiliarCXP.rdlc";
			this.rvMovimientosAuxiliares.Location = new System.Drawing.Point(0, 39);
			this.rvMovimientosAuxiliares.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rvMovimientosAuxiliares.Name = "rvMovimientosAuxiliares";
			this.rvMovimientosAuxiliares.ServerReport.BearerToken = null;
			this.rvMovimientosAuxiliares.Size = new System.Drawing.Size(1516, 450);
			this.rvMovimientosAuxiliares.TabIndex = 1;
			this.rvMovimientosAuxiliares.ZoomPercent = 150;
			...
			this.rvMovimientosAuxiliaresFactura.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptMovimientosAuxiliarCXPFacturas.rdlc";
			this.rvMovimientosAuxiliaresFactura.Location = new System.Drawing.Point(0, 39);
			this.rvMovimientosAuxiliaresFactura.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			...
			this.rvMovimientosAuxiliaresFactura.Size = new System.Drawing.Size(1516, 450);
			this.rvMovimientosAuxiliaresFactura.TabIndex = 47;
			this.rvMovimientosAuxiliaresFactura.ZoomPercent = 150;
			this.panel2.Controls.Add(this.cmbClientesHasta);
			this.panel2.Controls.Add(this.label4);
			this.panel2.Controls.Add(this.cmbClientesDesde);
			this.panel2.Controls.Add(this.label3);
			this.panel2.Controls.Add(this.label1);
			this.panel2.Controls.Add(this.btnRefrescaReporteBalanza);
			this.panel2.Controls.Add(this.rdoPorMesBalanzaComprobacion);
			this.panel2.Controls.Add(this.panel3);
			this.panel2.Controls.Add(this.panel4);
			this.panel2.Location = new System.Drawing.Point(4, 5);
			this.panel2.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.panel2.Name = "panel2";
			this.panel2.Size = new System.Drawing.Size(590, 178);
			...
			this.cmbClientesHasta.Location = new System.Drawing.Point(346, 135);
			this.cmbClientesHasta.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.cmbClientesHasta.Name = "cmbClientesHasta";
			this.cmbClientesHasta.Size = new System.Drawing.Size(136, 30);
			...
			this.label4.Location = new System.Drawing.Point(290, 141);
			...
			this.cmbClientesDesde.Location = new System.Drawing.Point(126, 135);
			this.cmbClientesDesde.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.cmbClientesDesde.Name = "cmbClientesDesde";
			this.cmbClientesDesde.Size = new System.Drawing.Size(136, 30);
			...
			this.btnRefrescaReporteBalanza.Location = new System.Drawing.Point(470, 9);
			this.btnRefrescaReporteBalanza.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnRefrescaReporteBalanza.Name = "btnRefrescaReporteBalanza";
			this.btnRefrescaReporteBalanza.Size = new System.Drawing.Size(112, 105);
			...
			this.rdoPorMesBalanzaComprobacion.Location = new System.Drawing.Point(11, 16);
			this.rdoPorMesBalanzaComprobacion.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.rdoPorMesBalanzaComprobacion.Name = "rdoPorMesBalanzaComprobacion";
			this.rdoPorMesBalanzaComprobacion.Size = new System.Drawing.Size(97, 26);
			...
			this.panel3.Location = new System.Drawing.Point(118, 64);
			this.panel3.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.panel3.Name = "panel3";
			this.panel3.Size = new System.Drawing.Size(364, 52);
			this.panel3.TabIndex = 41;
			this.cmbMesesHastaBalanza.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			this.cmbMesesHastaBalanza.Location = new System.Drawing.Point(8, 11);
			this.cmbMesesHastaBalanza.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cmbMesesHastaBalanza.Name = "cmbMesesHastaBalanza";
			this.cmbMesesHastaBalanza.Size = new System.Drawing.Size(187, 34);
			this.cmbMesesHastaBalanza.TabIndex = 19;
			this.cmbAñosHastaBalanza.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			this.cmbAñosHastaBalanza.Location = new System.Drawing.Point(228, 12);
			this.cmbAñosHastaBalanza.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cmbAñosHastaBalanza.Name = "cmbAñosHastaBalanza";
			this.cmbAñosHastaBalanza.Size = new System.Drawing.Size(113, 34);
			...
			this.panel4.Location = new System.Drawing.Point(118, 6);
			this.panel4.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.panel4.Name = "panel4";
			this.panel4.Size = new System.Drawing.Size(364, 52);
			this.panel4.TabIndex = 133;
			this.cmbMesesDesdeBalanza.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			this.cmbMesesDesdeBalanza.Location = new System.Drawing.Point(8, 11);
			this.cmbMesesDesdeBalanza.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cmbMesesDesdeBalanza.Name = "cmbMesesDesdeBalanza";
			this.cmbMesesDesdeBalanza.Size = new System.Drawing.Size(187, 34);
			this.cmbMesesDesdeBalanza.TabIndex = 19;
			this.cmbAñosDesdeBalanza.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			this.cmbAñosDesdeBalanza.Location = new System.Drawing.Point(228, 12);
			this.cmbAñosDesdeBalanza.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cmbAñosDesdeBalanza.Name = "cmbAñosDesdeBalanza";
			this.cmbAñosDesdeBalanza.Size = new System.Drawing.Size(113, 34);
			...
			this.cmbEmpresas.Location = new System.Drawing.Point(423, 11);
			...
			this.btnBuscaEmpresa.Location = new System.Drawing.Point(941, 8);
			...
			base.ClientSize = new System.Drawing.Size(1408, 805);

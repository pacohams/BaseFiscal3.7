...
{
	public class ImprimeCFDIsNomina : FormBase
	{
		...
		public ImprimeCFDIsNomina(List<EntFactura> ListaComprobantes)
		{
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			this.rvImpresionCFDIs.LocalReport.ReportEmbeddedResource = "LeeXML.Reportes.rptImprimeCFDIsNomina.rdlc";
